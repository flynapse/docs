...
AI Copilots are specialized intelligent assistants designed for different aviation roles and departments. Each copilot understands the specific terminology, procedures, and workflows of its domain, providing targeted assistance for your work.

**Key Features:**
- **Domain-Specific Knowledge**: Each copilot is trained on relevant aviation documentation
- **Natural Language Interaction**: Ask questions in plain English
- **Document Intelligence**: Find and analyze relevant technical documents
- **Collaboration Tools**: Share findings and add comments for your team
...
**AOCC Co-Pilot:**
- **Purpose**: Aircraft Operations Control Center
- **Documents**: Operations manuals, procedures
- **Users**: Operations controllers, dispatchers
- **Features**: Flight planning, operations management, decision support

**Crew Co-Pilot:**
- **Purpose**: Cabin Crew Operations
- **Documents**: Cabin procedures, safety manuals
- **Users**: Flight attendants, cabin crew
- **Features**: Passenger management, safety procedures, service protocols
...
**AOCC Co-Pilot:**
- **Best For**: Operations control, flight planning, decision support
- **Documents**: Operations manuals, procedures, guidelines
- **Use Cases**:
...
**How to Access:**
1. Look for the "AOCC Co-Pilot" card
2. Click "Launch" if available
3. Ask questions about operations procedures

### For Cabin Crew

**Crew Co-Pilot:**
- **Best For**: Cabin operations, passenger management, safety procedures
- **Documents**: Cabin procedures, safety manuals, service protocols
- **Use Cases**:
...
**How to Access:**
1. Find the "Crew Co-Pilot" card
2. Click "Launch" if you have access
3. Ask about cabin procedures and safety protocols
